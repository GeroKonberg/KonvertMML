...
+	cmp a,#$c9
	...
	bra ++
+	and a,#$7f
	cmp a,#$5a ;jump to voice command
	bmi +
	eor a,#$80
	jmp VoiceCommandRun
...
PresetISParam4:
	db $19,$26,$33,$3f,$4c,$59,$66,$6d,$70,$72,$75,$77,$70,$7c,$7f,$82
...
PresetVCMD: ;N-SPC to SMW VCMD conversion table [$DA-$FF]
	...
	db $00 ;df song volume
	db $E1 ;e0 song volume fade
	db $00 ;e1 tempo

	db $E3 ;e2 tempo fade
	db $E4 ;e3 global transposition
	db $00 ;e4 channel transposition
	db $E5 ;e5 tremolo on

	db $FD ;e6 tremolo off
	db $00 ;e7 volume
	...
	db $00 ;f4 percussion base
	db $00 ;f5 echo on

	db $00 ;f6 echo off
	db $00 ;f7 GAIN rate(?)
	db $00 ;f8 GAIN rate
	db $00 ;f9 GAIN release

	db $00 ;fa voice definer by amounts x 4 (skip)
	db $DA ;fb instrument
	db $00 ;fc misc event (skip)
	db $00 ;fd sub event (skip)
...
VCMDISPercDef:
	inc y
	mov a,(ReadSeq)+y ;skip percussion table (three bytes per entry)
	inc a
	mov y,#$03
	mul ya
	inc a
