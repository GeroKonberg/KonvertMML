...
+	inc DPMacroFlag ;store repeat calls for later
	pop a
	mov y,a
	pop a
...
VCMDSubEvent:
	inc y
	mov a,(ReadSeq)+y ;get sub event
	and a,#$07
	asl a
	mov x,a
	mov a,PresetSubIndex+1+x ;jump to sub VCMD
	push a
	mov a,PresetSubIndex+x
	push a
	ret


PresetSubIndex:
	dw ForceInterrupt ;00
	dw SubInvalid ;01
	dw SubVolumeRel ;02
	dw SubInvalid ;03
	dw SubLegatoOn ;04
