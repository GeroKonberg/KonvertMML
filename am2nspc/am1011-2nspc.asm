...
base $008800 ;SFC_IPL1
	...
	db $d7,$00,$fc,$d0,$f3,$ab,$01,$d0,$ef,$5f,$00,$25
...
base $027F84 ;SFC_IPL2
	...
	db $8f,$00,$f1,$cd,$f3,$bd,$e8,$00,$8d,$00,$cd,$04,$8e,$5f,$00,$25
...
VcmdDA: ;instrument
	...
	bpl +
--	mov x,a
	mov a,PresetInstTable+x
	bra ++
+	setc
	sbc a,#$1e ;first custom inst starts at 00 etc.
	push y
	mov y,#$06
	mul ya
	mov y,a
